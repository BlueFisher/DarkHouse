...
class propManager {
    constructor() {
        ...
        let a = config.weapon.gun.defaultSettings.get(config.weapon.gun.type.rifle);
        this.propGuns.push(new propGun(new utils_1.point(200, 200), new weapon_1.gun(config.weapon.gun.type.rifle, a)));
    }
